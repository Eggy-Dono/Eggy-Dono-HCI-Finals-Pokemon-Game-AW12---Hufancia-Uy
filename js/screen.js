    ...
    document.querySelectorAll('.trainer-wrapper').forEach((el) => {
      el.addEventListener('click', (ev) => {
        ...
        if (difficulty === 'easy') {
          ...
          document.querySelector('.screen').style.backgroundImage = 'url("./assets/arena-forrest.png")';
          ...
          game.opponentBag = [{ name: 'Potion', quantity: 3, energy: 50 }];
          document.querySelector('.screen').style.backgroundImage = 'url("./assets/arena-street.png")';
        } else {
          ...
          game.opponentBag = [{ name: 'Potion', quantity: 3, energy: 50 }];
          document.querySelector('.screen').style.backgroundImage = 'url("./assets/arena-final.png")';
        }
...
const nextTrainerScreen = `
  <div class="welcome--box">
      <h1>Round Won</h1>
      <p style="width: 90%; text-align:center">#{opponentTrainer} chooses #{pokemon} to fight next</p>
      <div style="display:flex; gap: 60px">
        <h3 class="deciscion--btn">Continue</h3>
        <h3 class="deciscion--btn">Retreat</h3>
      </div>
    </div>
`;
...
const welcomeScreen = `
  <div class="welcome--box pointer">
      <h3>          Welcome to Aly and Yugi's</h3>
      <h3>                Pokémon Game!</h3>                  
...
const choosePokemonScreen = `
  <div class="welcome--box">
      ...
      <p style="margin-bottom: 40px" class="s1">Click the Pokémon of your choice</p>
      <div class="choose-pokemon-box">
      <div class="pokeball-wrapper" data-pokemon="charmander">
        <p>Charmander</p>
        <img class="choose--pokemon-pokeball" src="./assets/pokeball.gif">
      </div>
...
const chooseDifficultyScreen = `
  <div class="welcome--box">
      ...
      <p style="margin-bottom: 20px; width: 90%; text-align: center;">Click a Trainer to choose your difficulty</p>
      <div class="choose-pokemon-box">
      <div class="trainer-wrapper" data-difficulty="easy">
        <p>Easy</p>
        <img style="width:100px;" src="./assets/trainer_2.gif">
        <p>Mr. X</p>
      </div>
      <div class="trainer-wrapper" data-difficulty="medium">
        <p>Middle</p>
        <img style="width:100px; margin-left: -20px" src="./assets/garry.webp">
        <p>Garry</p>
      </div>
        <div class="trainer-wrapper" data-difficulty="hard">
          <p>Hard</p>
          <img style="width:100px;" src="./assets/trainer_4.gif">
          <p>Bonnie</p>
        </div>
        </div>
  </div>
...
const wonScreen = `
<div class="welcome--box">
    <h3>Awesome, you won!!!</h3>
    <img style="width:300px;" src="./assets/pokemons.gif">
    <p>You're definitely a Pokémon Trainer!</p>
</div>
`;

const masterWonScreen = `
<div class="welcome--box">
    <img style="width:100%; height: auto;" src="./assets/drake.gif">
</div>
`;
